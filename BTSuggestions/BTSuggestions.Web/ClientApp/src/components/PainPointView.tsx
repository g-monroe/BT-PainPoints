...
export default class PainPointView extends React.Component<IPainPointViewProps,IPainPointViewState> {
  ...
  render () {
    ...
    return ( <><Collapse style={{marginLeft:'10%', marginRight:'10%', marginBottom: 16, marginTop: 16}} defaultActiveKey={['1','2']} >
    <Panel header="To Do" key="1">
      <PainPointTable/>
    </Panel>      
  </Collapse>
  <Collapse style={{margin:15}} defaultActiveKey={['1','2']} >
    <Panel header="Open Pain Points" key="1">
      <PainPointTable/>
    </Panel>      
  </Collapse>
  </>
